...
class RandGaussianNoised(Randomizable, MapTransform):
    ...
    def __init__(self, keys: MonaiDictionaryKeySelection, prob: float = 0.1, mean=0.0, std: float = 0.1):
        super().__init__(keys)
        self.prob = prob
        self.mean = mean
        self.std = std
...
class RandShiftIntensityd(Randomizable, MapTransform):
    ...
    def __init__(self, keys: MonaiDictionaryKeySelection, offsets, prob: float = 0.1):
        """
        Args:
            keys (hashable items): keys of the corresponding items to be transformed.
                See also: :py:class:`monai.transforms.compose.MapTransform`
...
class RandScaleIntensityd(Randomizable, MapTransform):
    ...
    def __init__(self, keys: MonaiDictionaryKeySelection, factors, prob: float = 0.1):
        """
        Args:
            keys (hashable items): keys of the corresponding items to be transformed.
                See also: :py:class:`monai.transforms.compose.MapTransform`
