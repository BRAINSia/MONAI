...
from monai.config.typing import MonaiDictionaryKeySelection, MonaiIndexSelection
...
class SpatialPadd(MapTransform):
    ...
    def __init__(self, keys: MonaiDictionaryKeySelection, spatial_size, method: str = "symmetric", mode="constant"):
        """
        Args:
...
class SpatialCropd(MapTransform):
    ...
    def __init__(self, keys: MonaiDictionaryKeySelection, roi_center=None, roi_size=None, roi_start=None, roi_end=None):
        """
        Args:
            keys (hashable items): keys of the corresponding items to be transformed.
                See also: :py:class:`monai.transforms.compose.MapTransform`
...
class CenterSpatialCropd(MapTransform):
    ...
    def __init__(self, keys: MonaiDictionaryKeySelection, roi_size):
        super().__init__(keys)
...
class RandSpatialCropd(Randomizable, MapTransform):
    ...
    def __init__(
        self, keys: MonaiDictionaryKeySelection, roi_size, random_center: bool = True, random_size: bool = True
    ):
        super().__init__(keys)
...
class CropForegroundd(MapTransform):
    ...
    def __init__(
        ...
        channel_indexes: Optional[MonaiIndexSelection] = None,
        margin=0,
    ):
        """
        Args:
