...
class SplitChanneld(MapTransform):
    ...
    def __init__(self, keys: MonaiDictionaryKeySelection, output_postfixes, to_onehot=False, num_classes=None):
        """
        Args:
...
class Activationsd(MapTransform):
    ...
    def __init__(
        self, keys: MonaiDictionaryKeySelection, output_postfix: str = "act", sigmoid=False, softmax=False, other=None
    ):
        """
        Args:
